    ...
    */
    ...
    'connections' => [
        ...
        'reverb' => [
            ...
            'options' => [
                // REVERB_HOST=0.0.0.0 e' per il binding del server.
                // Per il client (Laravel -> Reverb) serve un host raggiungibile
                // dentro la rete Docker: REVERB_SERVER_HOST=reverb.
