...
<body class="bg-gray-50 font-sans">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16 items-center">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    {{-- @auth: Questo blocco viene mostrato SOLO agli utenti che hanno fatto il login --}}
                    @auth
                    ...
                    {{-- @else: Questo blocco viene mostrato solo agli utenti NON loggati (visitatori) --}}
                    @else
    ...
    <main class="max-w-7xl mx-auto py-10 px-4 sm:px-6 lg:px-8">
        @yield('content') {{-- @yield dice a Laravel: "Qui metti il codice che trovi dentro @section('content')" --}}
    </main>

    @stack('scripts') {{-- @stack raccoglie tutto quello che scrivi dentro @push('scripts') nelle altre pagine --}}
